            ...
            <div class="card p-3 mb-4">
                ...
                <form action="{{ route('siswa.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="lokasi" class="form-control" placeholder="Contoh: Ruang Lab
                        1" required>
                    </div>
                    <div class="mb-3">
                        <label>Keterangan Keluhan</label>
                        <textarea name="ket" class="form-control" rows="3" placeholder="Jelaskan detail
                        kerusakan..." required></textarea>
                    </div>
